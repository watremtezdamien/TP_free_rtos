/*
 * @brief NXP MCB1768 Sysinit file
 *
 * @note
 ...
 ****************************************************************************/
/**
*@note : pour modification du board modifier ou rajouter des partie utile dnas cette
 partie entre les crochets mise en place du code necessaire correspondant a la */
/* Pin muxing configuration */
STATIC const PINMUX_GRP_T pinmuxing[] = {
    /* CAN1 */
    {0,  0,   IOCON_MODE_INACT | IOCON_FUNC1},	/* RD1 */
    {0,  1,   IOCON_MODE_INACT | IOCON_FUNC1},	/* TD1 */
	...
	{0,7,     IOCON_MODE_INACT | IOCON_FUNC3},
	...
	/* Joystick buttons. */
    {1, 24,  IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_UP */
    {1, 26, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_DOWN */
    {1, 23,  IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_LEFT */
    {1, 25, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_RIGHT */
    {1, 20, IOCON_MODE_INACT | IOCON_FUNC0},	/* JOYSTICK_PRESS */
		/*PWM*/
    ...
    /* CAN2 */
    {2,  7,   IOCON_MODE_INACT | IOCON_FUNC1},	/* RD2 */
    {2,  8,   IOCON_MODE_INACT | IOCON_FUNC1},	/* TD2 */
