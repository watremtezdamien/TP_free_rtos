...
/** @defgroup BOARD_NXP_MCB_1768 NXP MCB1768 board software API functions
 * @ingroup LPCOPEN_17XX_BOARD_MCB1768
...
/** @defgroup BOARD_NXP_MCB1768_OPTIONS BOARD: NXP MCB1768 board build options
